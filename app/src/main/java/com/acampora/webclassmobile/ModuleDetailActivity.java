 ...
 *
 * Last modified 10/8/16 10:29 PM
 */
...
//                .setAction("Action", null).show();
        ...
        SectionModule m = (SectionModule) getIntent().getSerializableExtra("sectionModule");
        if (m != null)
            module = m;
...
//            fragment.setArguments(arguments);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
//            navigateUpTo(new Intent(this, ModuleListActivity.class)); // Was navigating without keeping data
